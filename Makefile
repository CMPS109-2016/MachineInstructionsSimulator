...
$(CLIENT_EXE): $(CLIENT_BIN_OBJ)
	$(CC) $(CFLAGS) -o $(CLIENT_EXE) $(CLIENT_BIN_OBJ) $(CORE_BIN_OBJ) $(INST_BIN_OBJ) $(SOCK_BON_OBJ) -I $(INC_PATH) -I $(SOC_INCLUDE)
...
$(SERVER_EXE): $(SERVER_BIN_OBJ)
	$(CC) $(CFLAGS) -o $(SERVER_EXE) $(SERVER_BIN_OBJ) $(CORE_BIN_OBJ) $(INST_BIN_OBJ) $(SOCK_BON_OBJ) -I $(INC_PATH) -I $(SOC_INCLUDE)
